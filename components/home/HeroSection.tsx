      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-12 gap-12 items-center relative z-10">
        <div className="lg:col-span-7">
          ...
          <AnimateOnScroll variant="blur-in" delay={0.1}>
            <h1 className="text-5xl lg:text-7xl font-serif italic leading-tight mb-6">
              See Your Website Mockup In 48 Hours. <span className="text-primary not-italic font-display font-black block lg:inline">What's Next.</span>
            </h1>
          </AnimateOnScroll>
          
          <AnimateOnScroll variant="fade-up" delay={0.2}>
            <p className="text-lg text-slate-600 dark:text-slate-400 mb-8 max-w-xl leading-relaxed">
              Squadra builds high-converting websites for startups, e-com brands, and growing businesses, powered by AI and delivered faster than any traditional agency.
            </p>
          </AnimateOnScroll>
        ...
        <div className="lg:col-span-5">
          <AnimateOnScroll variant="fade-left" delay={0.3}>
            <div className="bg-white/5 backdrop-blur-xl border border-white/15 p-8 rounded-2xl shadow-2xl relative z-10">
              <h3 className="text-2xl font-bold mb-2">Get a Free Technology Assessment</h3>
              <p className="text-sm text-slate-400 mb-6">Fill in your details and we will be in touch within 24 hours.</p>
              <LeadForm />
              <p className="text-center text-xs text-slate-500 mt-4">🔒 No spam. No commitment. Just a conversation.</p>
            </div>
          </AnimateOnScroll>
        </div>
      </div>
